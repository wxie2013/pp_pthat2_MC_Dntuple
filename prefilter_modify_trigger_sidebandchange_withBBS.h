...
TString inputBname_PbPb="/scratch/halstead/x/xiao147/2018PbPb_rereco_data_Dntuple_07022019/MB10_add_pkpi/MB10_part2_0001_whole.root";
...
TString mycut_PbPb = "Dy>-1.&&Dy<1.&&abs(Dtrk1Eta)<1.2&&abs(Dtrk2Eta)<1.2&&abs(Dtrk3Eta)<1.2&&Dalpha<0.2&&(DsvpvDistance/DsvpvDisErr)>4.&&Dchi2cl>0.05&&phfCoincFilter2Th4&&pprimaryVertexFilter&&pclusterCompatibilityFilter&&abs(PVz)<15&&hiBin<180";
